    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
          ...
          <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center"><MessageSquare className="text-orange-500" /></div>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
          ...
          <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center"><Calendar className="text-blue-500" /></div>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
          ...
          <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center"><Bell className="text-emerald-500" /></div>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
          <div>
          ...
          <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center"><CreditCard className="text-rose-500" /></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm h-fit">
          ...
          <button className="w-full py-4 bg-[#10b981] text-white rounded-2xl font-bold">Pay Now</button>
        </div>
      </div>
    </div>
  );
