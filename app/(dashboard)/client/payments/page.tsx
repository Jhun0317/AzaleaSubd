...
// Forces the page to bypass the cache and sync with Admin/Dues immediately
...
export default async function PaymentsPage() {
  ...
  // 2. Use the variables from the Admin/Dues tab with safety fallbacks
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            ...
            {/* Syncs with the number saved in your Admin tab */}
          ...
          <div className="bg-emerald-500 p-8 rounded-[2.5rem] text-white shadow-lg shadow-emerald-100">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex items-center justify-between border border-white/20">
              <div>
                ...
                {/* Syncs with the GCash number saved in Admin */}
