              ...
              <div className="flex items-center gap-6">
                <div className="relative">
                  ...
                  <label
                    ...
                    className="absolute bottom-0 right-0 p-2 bg-emerald-600 rounded-full cursor-pointer hover:bg-emerald-700"
                  >
                    {uploading ? (
            ...
            <CardContent className="space-y-6">
              <div className="flex justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setNotificationPrefs(p => ({ ...p, email_announcements: v }))
                  }
                />
              </div>
              ...
              <div className="flex justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setNotificationPrefs(p => ({ ...p, email_payments: v }))
                  }
                />
              </div>
              ...
              <div className="flex justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setNotificationPrefs(p => ({ ...p, email_events: v }))
                  }
                />
              </div>
            </CardContent>
